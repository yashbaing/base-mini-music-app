...
function HomeContent() {
  ...
  const { play, currentTrack, currentTime, isPlaying } = useAudioPlayerContext();
  ...
  return (
    <main className="min-h-screen pb-16 sm:pb-20">
        ...
        <header className="mb-4 sm:mb-5 md:mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 sm:gap-3 md:gap-4">
            <div className="flex-1 w-full sm:w-auto">
              <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-1 bg-gradient-to-r from-orange-400 via-amber-400 to-yellow-500 bg-clip-text text-transparent leading-tight">
                Maratha Music
              </h1>
              <p className="text-gray-400 text-xs sm:text-sm">Chhatrapati Shivaji Maharaj&apos;s Musical Legacy</p>
            </div>
            <div className="w-full sm:w-auto flex-shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3">
        ...
        {allTracks.length > 0 ? (
          <div className="bg-gradient-to-br from-white/5 via-white/3 to-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border border-white/10 shadow-2xl">
            {/* Search Bar */}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 sm:gap-3 mb-3 sm:mb-4">
              <div className="flex items-center gap-2">
                <div className="p-1.5 sm:p-2 bg-gradient-to-br from-orange-500/30 to-amber-500/30 rounded-lg border border-orange-500/20 flex-shrink-0">
                  <Music2 className="text-orange-400" size={18} />
                </div>
                <div className="min-w-0">
                  <h2 className="text-base sm:text-lg md:text-xl font-bold text-white truncate">All Tracks</h2>
              ...
              {filteredTracks.length > 0 && (
                <button
                  ...
                  className="w-full sm:w-auto px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold hover:shadow-lg hover:shadow-orange-500/30 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-1.5 text-xs sm:text-sm touch-manipulation"
                >
          ...
          <div className="text-center py-20 sm:py-32">
            <div className="max-w-md mx-auto bg-white/5 backdrop-blur-xl rounded-3xl p-8 sm:p-12 border border-white/10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Welcome to Maratha Music</h2>
      ...
      {/* Fixed Bottom Player - Square with transparent background */}
      {currentTrack && (
        <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up py-3 sm:py-4">
